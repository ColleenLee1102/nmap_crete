...
#include "liblua/lobject.h"
#include "liblua/lstate.h"
//zl3 set symbolic
...
//	  StkId old_stack = L->top;
//	  StkId new_stack = old_stack -1;
//	  GCObject *og = new_stack->value_.gc;
//	  printf("about enter crete_make_concolic\n");
//	  //char* crete_symbolic_buffer = (char*)malloc(1024);
//	  //memset(crete_symbolic_buffer, 's', 1024);
//	  //crete_symbolic_buffer = og;
//	  crete_make_concolic(og, sizeof(*og), "lua_reading");
//  }
  //zl3
