...
/* $Id: nsock_event.c 37126 2018-01-28 21:18:17Z fyodor $ */
...
char *nse_readbuf(nsock_event nse, int *nbytes) {
  ...
  //zl3 modified
//  printf("about enter crete_make_concolic\n");
//  int nbyte_int = *nbytes;
//    char* crete_symbolic_buffer = (char *)malloc(nbyte_int);
//  memset(crete_symbolic_buffer, 's', nbyte_int);
//  crete_make_concolic(crete_symbolic_buffer, nbyte_int, "nmap_reading");
  //me->iobuf.str = crete_symbolic_buffer;
  //crete_make_concolic(fs_str(&(me->iobuf)), fs_length(&(me->iobuf)), "nmap_reading");
