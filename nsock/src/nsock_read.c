...
/* $Id: nsock_read.c 37126 2018-01-28 21:18:17Z fyodor $ */
...
void nmap_make_concolic(void *userdata){
	printf("entered nmap_make_concolic\n");
	crete_make_concolic(userdata, sizeof(*userdata), "nmap_userdata");
}
**/
//zl3 set symbolic
